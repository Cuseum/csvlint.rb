...
AF,1962,9989846
  EOL
    ...
    it "should create a table from pre-parsed CSVW metadata" do
      ...
      table = Csvlint::Csvw::Table.from_json(json["tables"][0], "https://w3c.github.io/csvw/tests/countries.json")

      expect(table).to be_a(Csvlint::Csvw::Table)
      expect(table.url.to_s).to eq("https://w3c.github.io/csvw/tests/countries.csv")
